...
export const getBlogs = () => api.get(url.GET_BLOGS);
// delete blog
export const deleteBlogs = blog => api.delete(url.DELETE_BLOG + '/' + blog);

// Ecommerce
// get Products
export const getProduct = (product) => api.get(url.GET_PRODUCT + "/" + product);
